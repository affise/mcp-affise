  ...
  mcpServer.registerPrompt(
    'auto_analysis',
    {
      ...
      argsSchema: {
        ...
        trafficback_countries:   z.unknown().optional(),
        trafficback_offers:      z.unknown().optional(),
        trafficback_devices:     z.unknown().optional(),
        trafficback_os:          z.unknown().optional(),
        ...
        focus_areas:             z.unknown().optional(),
